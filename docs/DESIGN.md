...
> Design notes for **tenant-order-buckets-java** — a runnable java example that Spring-style Java service that isolates course-store receipts and fulfillment updates in deterministic tenant buckets.
...
- **Feature code** — the actual task: tenant-order-archives.

...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of storage.bucket.get, storage.bucket.create, storage.object.head, storage.object.put, storage.object.presign) and reuse it from your own code.
